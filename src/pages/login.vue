<template>
  <div
    class="min-h-screen flex items-center justify-center bg-linear-to-br from-primary-50 to-secondary-50 py-12 px-4 sm:px-6 lg:px-8"
  >
    <div class="max-w-md w-full space-y-8">
      <!-- Header -->
      <div class="text-center">
        <div class="mx-auto flex items-center justify-center">
          <img :src="logo" alt="Logo UPA TIK" class="h-16 w-16" />
        </div>
        ...
        <div class="mt-3 flex items-center justify-center">
          <div
            class="flex items-center px-3 py-1 bg-warning-100 text-warning-800 rounded-full text-xs font-medium"
          >
          ...
          <div class="flex items-start">
            ...
            <div>
              ...
              <ul class="text-xs text-blue-700 space-y-1">
                <li>
                  • Hanya untuk pengguna dengan role <strong>Admin</strong>
                </li>
        ...
        <div class="space-y-4">
          ...
          >
            <div class="flex items-center">
              <Loader2
                v-if="isLoading"
                class="animate-spin h-5 w-5 mr-3 text-neutral-500"
              />
          ...
          >
            <AlertCircle
              class="h-5 w-5 text-error-500 mr-3 flex-shrink-0 mt-0.5"
            />
            <div>
          ...
          >
            <div class="flex items-start">
              <CheckCircle
                class="h-5 w-5 text-success-500 mr-3 flex-shrink-0 mt-0.5"
              />
              <div>
                <p class="text-sm font-medium text-success-800">Demo Mode</p>
                <p class="text-sm text-success-700 mt-1">
                  Untuk testing, gunakan akun Google yang sudah dikonfigurasi
                  sebagai admin di Firestore.
                </p>
              </div>
            </div>
          </div>
